...
export abstract class BaseGLGlyph {
  ...
  render(ctx: Context2d, indices: number[], mainglyph): boolean {
    // Get transform
...
export function attach_float(prog, vbo, att_name: string, n: number, visual: any, name: string): void {
...
export function attach_color(prog, vbo, att_name: string, n: number, visual: any, prefix: string): void {
